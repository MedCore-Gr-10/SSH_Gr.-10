...
export default function Users() {
  ...
  const isAtLeast18 = (birthDate) => {
    ...
    const adultDate = new Date(birth.getFullYear() + 18, birth.getMonth(), birth.getDate());
  ...
  const handleProfileSubmit = async (e) => {
    ...
    if (!isAtLeast18(newProfile.birth)) {
      alert("Profile date of birth must be for a person who is at least 18 years old.");
      return;
    }
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleProfileSubmit} className="modal-form-layout">
              ...
              <div className="input-field-group">
                ...
                <input type="date" name="birth" value={newProfile.birth} onChange={handleProfileInputChange} max={getAdultBirthDateLimit()} required />
              </div>
              <div className="input-field-group">
